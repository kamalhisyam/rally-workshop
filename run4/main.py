...
from helper.convert_to_img import convert_1D_array_to_img
from helper.train_model import train_channel, pred_channel
...
g_pred_arr = pred_channel(df_test, g_linear_est, 'G')
b_pred_arr = pred_channel(df_test, b_linear_est, 'B')
